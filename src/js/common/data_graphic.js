...
MG.options = { // <name>: [<defaultValue>, <availableType>, <description>]
  ...
  // show_years: [true, 'boolean'], // deprecated
  ...
  // xax_start_at_min: [false, 'boolean'], // deprecated
  xax_tick_length: [5, 'number', 'the x-axis\' tick length in pixels'],
  xax_units: [null, 'string', 'a prefix symbol to be shown alongside the x-axis\' labels'],
  ...
  // interpolate_tension: [0.7, 'number', 'increase the tension to fix artifacts when your data is irregular'], // deprecated
  ...
  // x_rollover_format: [null, 'function', 'a function or string that formats the x accessor\'s rollover text'], // deprecated
  x_rug: [false, 'boolean', 'show a rug plot along the x-axis'],
  // y_rollover_format: [null, 'function', 'a function or string that formats the y accessor\'s rollover text'], // deprecated
