...
The library now depends on D3 4. The impact on MG users is minimal, though if you do use D3 for other work, here is the [list of changes](https://github.com/d3/d3/blob/master/CHANGES.md) from 3.x to 4.0. The release notes for MG v2.10, planned for release in mid-July 2016, will include further details.
