...
| `xAxis.process_min_max` | `args`, `minX`, `maxX` | Called after calculating the min and max values for the X axis |
| `yAxis.process_min_max` | `args`, `min_y`, `max_y` | Called after calculating the min and max values for the Y axis |
