...
return this}
function process_line(args){console.log(args.time_series);if(args.missing_y_is_zero&&args.chart_type=='line'&&args.time_series){var first_date=args.data[0];var last_date=args.data[args.data.length-1];console.log(first_date,last_date);}
return this;}
