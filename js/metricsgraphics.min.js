...
var linked;if(($(args.target+' svg .main-line').length>0&&args.chart_type!='line')||($(args.target+' svg .points').length>0&&args.chart_type!='point')||($(args.target+' svg .histogram').length>0&&args.chart_type!='histogram')){$(args.target).empty();}
if($(args.target).is(':empty')){d3.select(args.target).append('svg').classed('linked',args.linked).attr('width',args.width).attr('height',args.height);}
