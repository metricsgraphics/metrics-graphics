...

{
  ...
  var mg_targeted_legend = function mg_targeted_legend(_ref2) {
    var legend_target = _ref2.legend_target,
  ...
  var barChart = function barChart(args) {
    ...
    this.rollover = function () {
      ...
      bars.on('mouseover', _this.rolloverOn(args)).on('mouseout', _this.rolloverOff(args)).on('mousemove', _this.rolloverMove(args));
    ...
    this.rolloverOn = function (args) {
      var svg = mg_get_svg_child_of(args.target);
      var label_accessor = _this.is_vertical ? args.x_accessor : args.y_accessor;
      var data_accessor = _this.is_vertical ? args.y_accessor : args.x_accessor;
      var label_units = _this.is_vertical ? args.yax_units : args.xax_units;
  ...
  MG.register('bar', barChart, _defaults);
}

{
  var histogram = function histogram(args) {
    ...
    this.rollover = function () {
      ...
      bar.append('rect').attr('x', 1).attr('y', args.buffer + (args.title ? args.title_y_position : 0)).attr('width', function (d, i) {
        ...
        return args.height;
      }).attr('opacity', 0).on('mouseover', _this2.rolloverOn(args)).on('mouseout', _this2.rolloverOff(args)).on('mousemove', _this2.rolloverMove(args));
    ...
    this.windowListeners = function () {
      mg_window_listeners(_this2.args);
      return _this2;
    };
  ...
  MG.register('histogram', histogram, _defaults2);
}

{
  var mg_line_color_text = function mg_line_color_text(elem, _ref3, _ref4) {
    var line_id = _ref3.line_id;
  ...
  var mg_add_area_generator = function mg_add_area_generator(_ref5, plot) {
    var scalefns = _ref5.scalefns,
        scales = _ref5.scales,
        interpolate = _ref5.interpolate,
        flip_area_under_y_value = _ref5.flip_area_under_y_value;
  ...
  var mg_add_flat_line_generator = function mg_add_flat_line_generator(_ref6, plot) {
    var y_accessor = _ref6.y_accessor,
        scalefns = _ref6.scalefns,
        scales = _ref6.scales,
        interpolate = _ref6.interpolate;
  ...
  var mg_add_line_generator = function mg_add_line_generator(_ref7, plot) {
    var scalefns = _ref7.scalefns,
        interpolate = _ref7.interpolate,
        missing_is_zero = _ref7.missing_is_zero,
        y_accessor = _ref7.y_accessor;
  ...
  var mg_add_confidence_band = function mg_add_confidence_band(_ref8, plot, svg, which_line) {
    var show_confidence_band = _ref8.show_confidence_band,
        transition_on_update = _ref8.transition_on_update,
        data = _ref8.data,
        target = _ref8.target;
  ...
  var mg_add_area = function mg_add_area(_ref9, plot, svg, which_line, line_id) {
    var data = _ref9.data,
        target = _ref9.target,
        colors = _ref9.colors;
  ...
  var mg_color_line = function mg_color_line(_ref10, this_path, which_line, line_id) {
  ...
  var mg_add_line_element = function mg_add_line_element(_ref11, plot, this_path, which_line) {
    var animate_on_load = _ref11.animate_on_load,
        data = _ref11.data,
        y_accessor = _ref11.y_accessor,
  ...
  var mg_add_legend_group = function mg_add_legend_group(_ref12, plot, svg) {
    var legend = _ref12.legend;
  ...
  var mg_add_rollover_circle = function mg_add_rollover_circle(_ref13, svg) {
    ...
    if (colors && colors.constructor === Array) {
      circle.attr('class', function (_ref14) {
        var line_id = _ref14.line_id;
      ...
      circle.attr('class', function (_ref15, i) {
        var line_id = _ref15.line_id;
  ...
  var mg_set_unique_line_id_for_each_series = function mg_set_unique_line_id_for_each_series(_ref16) {
    var data = _ref16.data,
        custom_line_color_map = _ref16.custom_line_color_map;
  ...
  var mg_nest_data_for_voronoi = function mg_nest_data_for_voronoi(_ref17) {
  ...
  var nest_data_for_aggregate_rollover = function nest_data_for_aggregate_rollover(_ref18) {
    var x_accessor = _ref18.x_accessor,
        data = _ref18.data,
        x_sort = _ref18.x_sort;
  ...
  var mg_add_aggregate_rollover = function mg_add_aggregate_rollover(args, svg, rollover_on, rollover_off, rollover_move, rollover_click) {
    ...
    var xf = data_nested.map(function (_ref19) {
      var key = _ref19.key;
    ...
    }).attr('class', function (_ref20) {
      var values = _ref20.values;

      var line_classes = values.map(function (_ref21) {
        var line_id = _ref21.line_id;
  ...
  var mg_configure_singleton_rollover = function mg_configure_singleton_rollover(_ref22, svg) {
    var data = _ref22.data;

    svg.select('.mg-rollover-rect rect').on('mouseover')(data[0][0], 0);
  };

  var mg_configure_voronoi_rollover = function mg_configure_voronoi_rollover(_ref23, svg) {
    var data = _ref23.data,
        custom_line_color_map = _ref23.custom_line_color_map;
  ...
  var mg_rollover_format_id = function mg_rollover_format_id(d, _ref24) {
    var x_accessor = _ref24.x_accessor,
        utc_time = _ref24.utc_time,
        linked_format = _ref24.linked_format;
  ...
  var mg_configure_aggregate_rollover = function mg_configure_aggregate_rollover(_ref25, svg) {
    var data = _ref25.data;

    var rect = svg.selectAll('.mg-rollover-rect rect');
    var rect_first = rect.nodes()[0][0] || rect.nodes()[0];
    if (data.filter(function (_ref26) {
  ...
  var mg_is_standard_multiline = function mg_is_standard_multiline(_ref27) {
    var data = _ref27.data,
        aggregate_rollover = _ref27.aggregate_rollover;

    return data.length > 1 && !aggregate_rollover;
  };

  var mg_is_aggregated_rollover = function mg_is_aggregated_rollover(_ref28) {
    var data = _ref28.data,
        aggregate_rollover = _ref28.aggregate_rollover;

    return data.length > 1 && aggregate_rollover;
  };

  var mg_is_singleton = function mg_is_singleton(_ref29) {
  ...
  var mg_remove_dangling_bands = function mg_remove_dangling_bands(_ref30, svg) {
    var existing_band = _ref30.existing_band;
  ...
  var mg_update_aggregate_rollover_circle = function mg_update_aggregate_rollover_circle(_ref31, svg, datum) {
    var scales = _ref31.scales,
        x_accessor = _ref31.x_accessor,
        y_accessor = _ref31.y_accessor,
        point_size = _ref31.point_size;
  ...
  var mg_update_generic_rollover_circle = function mg_update_generic_rollover_circle(_ref32, svg, d) {
    var scales = _ref32.scales,
        x_accessor = _ref32.x_accessor,
        y_accessor = _ref32.y_accessor,
        point_size = _ref32.point_size;
  ...
  var mg_trigger_linked_mouseouts = function mg_trigger_linked_mouseouts(_ref33, d, i) {
    var linked = _ref33.linked,
        utc_time = _ref33.utc_time,
        linked_format = _ref33.linked_format,
        x_accessor = _ref33.x_accessor;
  ...
  var mg_remove_active_data_points_for_aggregate_rollover = function mg_remove_active_data_points_for_aggregate_rollover(args, svg) {
    svg.selectAll('circle.mg-line-rollover-circle').filter(function (_ref34) {
      var length = _ref34.length;
      return length > 1;
    }).style('opacity', 0);
  };

  var mg_remove_active_data_points_for_generic_rollover = function mg_remove_active_data_points_for_generic_rollover(_ref35, svg, _ref36) {
    var custom_line_color_map = _ref35.custom_line_color_map,
        data = _ref35.data;
    var line_id = _ref36.line_id;
...
function mg_color_point_mouseover(_ref45, elem, d) {
  var color_accessor = _ref45.color_accessor,
      scalefns = _ref45.scalefns;
...

{
      ...
      return function (d, i) {
        ...
        if (args.linked && !MG.globals.link) {
          ...
          d3.selectAll('.mg-voronoi .path-' + i).each(function () {
            d3.select(_this4).on('mouseover')(d, i);
          });
        }
    ...
    this.rolloverOff = function (args) {
      ...
      return function (d, i) {
        if (args.linked && MG.globals.link) {
          ...
          d3.selectAll('.mg-voronoi .path-' + i).each(function () {
            d3.select(_this4).on('mouseout')(d, i);
          });
        }
  ...
  MG.register('point', pointChart, _defaults4);
}
