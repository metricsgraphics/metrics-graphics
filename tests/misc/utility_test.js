...
test('getSvgChildOf', function () {
  d3.select('#qunit-fixture').append('svg')

  var svg_element_with_node = getSvgChildOf(document.querySelector('#qunit-fixture'))
  var svg_element_with_text = getSvgChildOf('#qunit-fixture')
...
test('targetRef', function () {
  var chart_area2 = document.createElement('div')
  targetRef(chart_area2)
...
test('compareType', function () {
  [
    ...
    equal(compareType(i[0], i[1]), i[2], i)
  })
})
